...
const rawStorageBucket = (import.meta as any)?.env?.VITE_FIREBASE_STORAGE_BUCKET || 'church-app-35f50.firebasestorage.app';
const firebaseConfig = {
  ...
  storageBucket: String(rawStorageBucket || 'church-app-35f50.firebasestorage.app'),
