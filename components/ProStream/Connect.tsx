    ...
    <div className="flex items-center justify-center h-screen w-screen bg-[#1a1a1a] text-white p-4 font-sans">
      <div className="text-center bg-[#1e1e1e] p-8 rounded-xl shadow-2xl border border-gray-700 w-full max-w-md">
        <div className="flex items-center justify-center space-x-4 mb-6">
           <FiSettings className="w-12 h-12 text-blue-500" />
        ...
        <div className="space-y-4">
          ...
          >
            <FiSettings className="w-6 h-6 mr-3 transition-transform group-hover:rotate-12" />
          ...
          >
            <FiVideo className="w-6 h-6 mr-3 transition-transform group-hover:scale-110" />
            Continue as Camera
          </button>
        </div>
